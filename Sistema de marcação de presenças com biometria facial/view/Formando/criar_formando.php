...
<div id="cadastro_aluno" class="content-section">
    <div class="form-container">
        ...
        <a href="logout.php" class="exit-top">
            <i class="fas fa-sign-out-alt"></i> Sair
        </a>

        <h2 style="margin-bottom: 25px; color: var(--cor-primaria);">
            <i class="fas fa-user-plus"></i> Cadastro de Formando
        </h2>

        <form action="../../controller/FormandoController.php?action=create" method="POST" enctype="multipart/form-data">
            <div class="form-grid">
                <div class="form-group">
                    <label>Nome Completo</label>
                    <input type="text" name="nome" placeholder="Ex: Marvin Marsol" required>
                </div>
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" name="email" placeholder="marvin@email.com" required>
                </div>

                <div class="form-group">
                    <label>Telefone</label>
                    <input type="text" name="telefone" placeholder="XXXXXXXXX">
                </div>
